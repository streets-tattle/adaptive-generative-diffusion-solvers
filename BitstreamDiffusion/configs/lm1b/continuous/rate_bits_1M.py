...
# LM1B unconditional continuous baseline on raw-binary bitstreams.
# Fair data-exposure setup: 128 semantic tokens/sample, global batch 512,
# exact target of 1,000,000 optimizer steps (trainer must stop by global_step).
# Same as the semantic-bits continuous baseline, but without semantic binarization.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_rate_raw_binary_bits_1M"
    cfg.device = "cuda"
