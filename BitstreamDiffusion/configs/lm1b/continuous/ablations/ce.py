...
# Ablation: binary CE instead of binary score matching.
# Everything else stays identical to the final default design.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_rate_raw_binary_bits_1M_binary_ce"
    cfg.device = "cuda"
    ...
    # ABLATION CHANGE: Binary CE instead of SM
    ...
    cfg.logging.group = "continuous_rate_raw_binary_bits_1M_binary_ce"
