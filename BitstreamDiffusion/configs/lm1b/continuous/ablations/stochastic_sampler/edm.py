...
def get_config():
    ...
    cfg.train.entropy_use_for_sampling = False # EDM ablation
    ...
    out_dir_name = f"eval_stochastic_pareto_edm_seed{eval_seed}"
    ...
    def add_spec(*, target_nfe, ati_eta, stochastic_enabled, gamma_target=None, s_noise=1.003, qlo=0.0, qhi=1.0):
        ...
        if stochastic_enabled:
            ...
            # Retaining the standard bounds despite not using entropy scheduling, allowing stochasticity comparison
