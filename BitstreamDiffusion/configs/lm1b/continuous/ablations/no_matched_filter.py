...
# Ablation: remove analytic matched-filter residual.
...
def get_config():
    ...
    # ABLATION CHANGE: No continuous logit scaling
    ...
    cfg.logging.group = "continuous_rate_raw_binary_bits_1M_no_matched_filter"
