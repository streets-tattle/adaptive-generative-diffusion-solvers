...
# Representational ablation:
# continuous diffusion over one-hot token vectors instead of bitstreams.
# Run a short sanity job first before launching the 1M-step run.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_onehot_tokens_ce_1M_v4"
    cfg.device = "cuda"
    ...
    # Disabled the matched filter to prevent numerical instability
    cfg.model.continuous_logit_scaling = "none"
    
    # These parameters are now ignored by the postprocessor, but you can leave them 
    # or set them to None for cleanliness.
    cfg.model.matched_filter_center = 1.0 / 30522.0  
    ...
    cfg.diffusion.continuous.data_center = 1.0 / 30522.0
    ...
    cfg.train.external_ppl.num_sampling_steps = 128
    ...
    cfg.logging.group = "continuous_onehot_tokens_ce_1M"
