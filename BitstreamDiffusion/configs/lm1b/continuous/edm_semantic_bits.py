...
# LM1B unconditional continuous baseline on semantic bitstreams.
# Shared trunk with the token baselines; compact bit-specific adapters / heads.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_edm_semantic_bits"
    cfg.device = "cuda"
    ...
    # ------------------------------------------------------------------
    # Continuous diffusion (EDM-style)
    # ------------------------------------------------------------------
    ...
    # Archival checkpoints for later post-training evaluation
    ...
    cfg.train.checkpointing.interval.keep_last = 0  # 0 => keep all archival checkpoints
    ...
    cfg.train.vlb.batch_size = cfg.train.batch_size
    ...
    cfg.evaluation.mauve.device_id = 0
    cfg.evaluation.mauve.batch_size = 128
    ...
    cfg.evaluation.mauve.compute_full_text = False
    ...
    cfg.logging.group = "lm1b_continuous_semantic_bits_trunk768"
