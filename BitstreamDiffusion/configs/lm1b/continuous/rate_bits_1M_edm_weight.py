#configs/lm1b/continuous/rate_bits_1M_edm_weight.py
from ml_collections import config_dict


# LM1B unconditional continuous rate-based raw-binary bitstream model.
# Isolation ablation:
#   SAME as the current rate-based run, except:
#       - loss_weighting = "edm"
#   Keep entropy-driven sigma sampling fully enabled with gamma_max = 1.0
#   so we isolate the effect of optimizer weighting.
...
def get_config():
    ...
    # ISOLATION CHANGE: keep the orange sampler/schedule, change only weighting
