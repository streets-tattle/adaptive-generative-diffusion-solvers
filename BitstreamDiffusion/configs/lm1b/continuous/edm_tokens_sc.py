...
# LM1B unconditional continuous baseline on one-hot token vectors in R^V.
# Same trunk as the other models; full V<->768 adapters and full 768->V output head.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_edm_onehot_tokens_sc"
    cfg.device = "cuda"
    ...
    cfg.cond.null_strategy = "data_center"
    ...
    # input centering and matched-filter centering are intentionally different
    ...
    cfg.diffusion.continuous.data_center = 1.0 / cfg.data.vocab_size
    ...
    # assumes your trainer/loss path supports continuous token score matching
    cfg.train.loss_type = "token_sm"
    ...
    cfg.train.entropy_buffer_size = 50_000
    ...
    cfg.logging.group = "lm1b_continuous_onehot_tokens_trunk768"
