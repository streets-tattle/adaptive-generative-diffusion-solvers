...
# CE loss + unit weighting + exact MSE entropy proxy + online sqrt-rate schedule + SC
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/continuous_onehot_tokens_sc_ce_sqrtrate"
    cfg.device = "cuda"
