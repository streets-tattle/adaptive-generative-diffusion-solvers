...
# LM1B unconditional discrete absorb-tokens baseline.
# Same trunk as the continuous models; token-native full 768->V output head.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/discrete_absorb_tokens"
    cfg.device = "cuda"
    ...
    cfg.data.sequence_len = 128
    cfg.data.val_fraction = 0.005
    cfg.data.vocab_size = 30523  # bert vocab + absorbing MASK state
    cfg.data.mask_token_id = 30522
    cfg.data.channels = 1
    ...
    cfg.diffusion.discrete.q_matrix_type = "absorb"
    cfg.diffusion.discrete.schedule = "log_linear"
    ...
    cfg.train.mauve.micro_batch_size = 256
    ...
    cfg.evaluation.checkpoint_path = f"runs/{cfg.experiment}/checkpoints/step=000450000.pt"
    cfg.evaluation.out_dir = f"runs/{cfg.experiment}/evaluation_frontier_step450k"
    cfg.evaluation.samples_dir = f"runs/{cfg.experiment}/evaluation_frontier_step450k/samples"
    cfg.evaluation.results_csv = f"runs/{cfg.experiment}/evaluation_frontier_step450k/results.csv"
    cfg.evaluation.shared_text_cache_dir = f"runs/{cfg.experiment}/evaluation_frontier_step450k/shared_text_cache"
    ...
    cfg.evaluation.mauve.checkpoints = ["step=000450000.pt"]
    ...
    cfg.evaluation.external_ppl.samplers = ["tweedie"]
    ...
    cfg.evaluation.external_ppl.checkpoints = ["step=000450000.pt"]
    ...
    cfg.logging.group = "lm1b_absorb_tokens_fullhead_trunk768"
