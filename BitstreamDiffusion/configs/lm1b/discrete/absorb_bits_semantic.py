...
# LM1B unconditional discrete absorb-bits baseline.
# Same trunk as the token baselines; compact bit adapters / head.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/discrete_absorb_semantic_bits"
    cfg.device = "cuda"
    ...
    cfg.logging.group = "lm1b_absorb_bits_trunk768"
