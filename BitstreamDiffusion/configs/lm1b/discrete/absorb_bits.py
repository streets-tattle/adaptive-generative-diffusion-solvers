...
# LM1B unconditional discrete absorb baseline on raw-binary bitstreams.
# Same as the semantic-bits discrete baseline, but without semantic binarization.
...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/lm1b/discrete_absorb_raw_binary_bits"
    cfg.device = "cuda"
    ...
    cfg.data.vocab_size = 3
    cfg.data.mask_token_id = 2
    cfg.data.channels = 1
    ...
    cfg.logging.group = "lm1b_absorb_raw_binary_bits_trunk768"
