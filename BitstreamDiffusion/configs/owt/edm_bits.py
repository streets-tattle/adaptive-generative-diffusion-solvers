...
def get_config():
    ...
    cfg.experiment = "paper/unconditional_text/owt/continuous_edm_raw_binary_bits_1M"
    cfg.device = "cuda"

    # ------------------------------------------------------------------
    # Data
    # Paper-faithful OpenWebText setup for fair FLM comparison:
    # - HF openwebtext
    # - GPT-2 tokenizer
    # - train split: train[:-100000]
    # - val/test split: train[-100000:]
    # - wrap=True
    # - flat token stream with EOS inserted between docs
    # - blocks of L-2 content tokens
    # - final sequence = [BOS] + content + [EOS], total length 1024
    # ------------------------------------------------------------------
    ...
    cfg.model.patch_size = 16  # 1 GPT-2 token = 16 raw bits
    ...
    cfg.train.mauve.micro_batch_size = 128
